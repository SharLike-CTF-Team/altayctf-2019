...
<div class="container-fluid fullscreen bg-welcome align-items-center d-flex" id="forms">
    <div class="container console">
        <div class="row">
            <div class="col-6">
                <?php echo $__env->make('auth.login_form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
            <div class="col-6">
                <div class="col-8 h-100 mx-auto my-auto">
                    ...
                    <div class="row h-75 justify-content-center align-items-center">
                        <div class="col">
                            <p><a href="<?php echo e(route('register')); ?>" class="btn button-console">Зарегистрироваться</a></p>
                        </div>
                    </div>
                </div>
            </div>
