<div class="container mb-5">
    <div class="row justify-content-center">
        <div class="col-8  console">
            ...
            <form id="addNews" class="mt-3" action="{{ route('profile',['id'=>Auth::user()->id]) }}" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <textarea class="form-control input" id="text" name="text" rows="5">{{ old('text') }}</textarea>
                        </div>
                    </div>
                </div>
